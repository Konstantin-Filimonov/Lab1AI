"""
Этап 9. Сводное сравнение моделей.

Читает results/scoring_template.csv (после того как вы вручную проставили баллы)
и строит:
  - таблицу средних показателей по каждой модели (латентность, суммарный балл)
  - таблицу средних показателей по каждой модели И типу задачи
Сохраняет обе в results/summary.csv и results/summary_by_type.csv,
а также печатает их в консоль для вставки в отчёт.
"""
